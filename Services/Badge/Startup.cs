...
namespace Badge
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextPool<BadgeDbContext>(it =>
            ...
            builder.RegisterType<UserPostedBlogConsumer>();
            builder.Register(context =>
                {
                    var busControl = Bus.Factory.CreateUsingRabbitMq(cfg =>
                    {
                        ...
                        cfg.ReceiveEndpoint(host, "badge" + Guid.NewGuid().ToString(), e =>
                        {
                            e.LoadFrom(context);
                        });
                    });
